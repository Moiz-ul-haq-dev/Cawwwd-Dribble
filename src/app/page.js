      ...
      <section className="flex mx-8 my-5">
        ...
        <div className="block w-full">
          ...
          <div className="lg:flex block w-full mt-3 justify-between items-center">
            <button className="flex items-center border rounded lg:rounded-2xl px-1 py-2 ml-5">Ready To Ship <Image className="lg:ml-2 ml-0" src={'/images/cancel.png'} width={20} height={20} layout="relative" objectFit="cover" /></button>
            <button className="flex items-center border rounded lg:rounded-2xl px-1 py-2 ml-5">Paid Samples <Image className="lg:ml-2 ml-0" src={'/images/cancel.png'} width={20} height={20} layout="relative" objectFit="cover" /></button>
            <button className="flex items-center border rounded lg:rounded-2xl px-1 py-2 ml-5">Price Maximum <Image className="lg:ml-2 ml-0" src={'/images/cancel.png'} width={20} height={20} layout="relative" objectFit="cover" /></button>
            <button className="flex items-center border rounded lg:rounded-2xl px-1 py-2 ml-5">Price Minimum <Image className="lg:ml-2 ml-0" src={'/images/cancel.png'} width={20} height={20} layout="relative" objectFit="cover" /></button>
            <button className="flex items-center border rounded lg:rounded-2xl px-1 py-2 ml-5">Minimal Order <Image className="lg:ml-2 ml-0" src={'/images/cancel.png'} width={20} height={20} layout="relative" objectFit="cover" /></button>
